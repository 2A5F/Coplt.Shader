...
public class TestLog
{
    ...
    {
        var a = simd_log_float.Log2(new float4(v).UnsafeGetInner()).GetElement(0);
        var b = MathF.Log2(v);
        Console.WriteLine($"{a}");
        Console.WriteLine($"{b}");
    ...
    {
        var a = simd_log_float.Log2(new float4(v).UnsafeGetInner()).GetElement(0);
        var b = simd_log_float.Log2(new float2(v).UnsafeGetInner()).GetElement(0);
        Console.WriteLine($"{a}");
        Console.WriteLine($"{b}");
        Assert.That(a, Is.EqualTo(b).Within(0.000_1f).Percent);
    }
    ...
    {
        var a = simd_log_double.Log2(new double4(v).UnsafeGetInner()).GetElement(0);
        var b = Math.Log2(v);
        Console.WriteLine($"{a}");
        Console.WriteLine($"{b}");
    ...
    {
        var a = simd_log_double.Log2(new double4(v).UnsafeGetInner()).GetElement(0);
        var b = simd_log_double.Log2(new double2(v).UnsafeGetInner()).GetElement(0);
        Console.WriteLine($"{a}");
        Console.WriteLine($"{b}");
